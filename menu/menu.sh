...
echo -e " ${MB}[11]${NC} ${YB}Renew Cert${NC}         ${MB}[16]${NC} ${YB}Reboot VPS${NC}"
echo -e " ${MB}[12]${NC} ${YB}About Script${NC}       ${MB}[17]${NC} ${YB}Clear Cache${NC}"
echo -e " ${MB}[18]${NC} ${YB}Cek Bandwith${NC}"
echo -e ""
